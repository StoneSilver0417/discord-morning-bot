...
if __name__ == "__main__":
    ...
    print(f"       • GEMINI_MODEL_WEATHER={Config.GEMINI_MODEL_WEATHER} (기본: gemini-2.0-flash)")
    print(f"       • GEMINI_MODEL_STOCKS={Config.GEMINI_MODEL_STOCKS} (기본: gemini-2.0-flash)")
