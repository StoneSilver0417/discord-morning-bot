...
if __name__ == "__main__":
    ...
    print(f"       • GEMINI_MODEL_WEATHER={Config.GEMINI_MODEL_WEATHER} (기본: gemini-2.5-flash)")
    print(f"       • GEMINI_MODEL_STOCKS={Config.GEMINI_MODEL_STOCKS} (기본: gemini-2.5-flash)")
    print(f"       • GEMINI_MODEL_IT_NEWS={Config.GEMINI_MODEL_IT_NEWS} (기본: gemini-2.5-flash)")
    print(f"       • GEMINI_MODEL_CIVIL_SERVICE={Config.GEMINI_MODEL_CIVIL_SERVICE} (기본: gemini-2.5-flash)")
    print(f"       • GEMINI_MODEL_FALLBACK={Config.GEMINI_MODEL_FALLBACK} (기본: gemini-2.5-flash)")
