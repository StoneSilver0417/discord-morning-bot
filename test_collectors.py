...
if __name__ == "__main__":
    ...
    print(f"       • GEMINI_MODEL_IT_NEWS={Config.GEMINI_MODEL_IT_NEWS} (기본: gemini-3.1-pro-preview)")
    print(f"       • GEMINI_MODEL_CIVIL_SERVICE={Config.GEMINI_MODEL_CIVIL_SERVICE} (기본: gemini-3.1-pro-preview)")
