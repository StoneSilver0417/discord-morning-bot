...
class Config:
    ...
    GEMINI_MODEL_IT_NEWS = os.getenv("GEMINI_MODEL_IT_NEWS") or "gemini-3.1-pro-preview"
    GEMINI_MODEL_CIVIL_SERVICE = os.getenv("GEMINI_MODEL_CIVIL_SERVICE") or "gemini-3.1-pro-preview"
