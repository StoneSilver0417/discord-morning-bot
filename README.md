...
| 환경변수 | 기본값 | 설명 |
|----------|--------|------|
| `GEMINI_MODEL_WEATHER` | `gemini-2.5-flash` | 날씨 브리핑 요약 모델 |
| `GEMINI_MODEL_STOCKS` | `gemini-2.5-flash` | 주식/증시 동향 요약 모델 |
| `GEMINI_MODEL_IT_NEWS` | `gemini-2.5-flash` | IT 뉴스 큐레이션 및 요약 모델 |
| `GEMINI_MODEL_CIVIL_SERVICE` | `gemini-2.5-flash` | 공무원 뉴스 큐레이션 및 요약 모델 |
| `GEMINI_MODEL_FALLBACK` | `gemini-2.5-flash` | 모델 호출 실패 시 대체(Fallback) 모델 |
